...
def _optional_str_attr(obj: Any, attr: str) -> str | None:
    """Return an optional string attribute without leaking mock objects into JSON."""
...
def build_request_summary(request_data: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "auto_model_tier": _optional_str_attr(request_data, "auto_model_tier"),
        "auto_model_reason": _optional_str_attr(request_data, "auto_model_reason"),
    }
